module.exports = {
  ...
  'Click the QR code or scan it by smartphone to retrieve server information automatically': 'QRコードをクリック、またはスキャンして自動的にサーバの情報を取得できます',
  ...
  '最新注册用户': '最近の登録ユーザー',
  'Recently logged in user': '最近のログインユーザー',
  '支付宝订单': 'Alipay でお支払注文',
